...
import MyFormInput from "./components/MyFormInput.js";
import ListNotesAktif from "./components/ListNotesAktif.js";
import ListArsipNoted from "./components/ListArsipNoted.js";
import { getInitialData, showFormattedDate } from "./utils/index.js";
import LimitComponent from "./components/LimitComponent.js";
...
class NotedApps extends React.Component {
  ...
  onDelete = (noteId) => {
    ...
    if (!isConfirmed) {
      ...
      alert("note with id nya " + noteId + " deleted");
    }
  };
